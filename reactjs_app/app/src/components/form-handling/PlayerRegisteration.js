...
const PlayerRegistration = () => {
    ...
    const [state, setState] = useState({ name: null , age: 0, awardswon:["State Award ", "National Award"],score:0,roleOptions:["bowler ","keeper ","batsman "], role:[],errorMsg:"Error will be shown here" });
